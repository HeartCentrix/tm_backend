-- ============================================================
-- TM Vault — full schema migration (idempotent)
-- Generated from local PostgreSQL state
-- Safe to run multiple times against any environment.
-- Usage:
--   psql "$DATABASE_URL" -f 2026_04_18_full_schema.sql
-- ============================================================
...
--
-- Name: access_groups; Type: TABLE; Schema: tm_vault; Owner: -
--
...
--
-- Name: access_groups access_groups_pkey; Type: CONSTRAINT; Schema: tm_vault; Owner: -
--
...
--
-- Name: idx_snapshot_items_search_vector; Type: INDEX; Schema: tm_vault; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_snapshot_items_search_vector ON tm_vault.snapshot_items USING gin (search_vector);


--
-- Name: idx_snapshot_items_snap_type_ext; Type: INDEX; Schema: tm_vault; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_snapshot_items_snap_type_ext ON tm_vault.snapshot_items USING btree (snapshot_id, item_type, external_id);
...
--
-- Name: tenants_external_tenant_id_type_key; Type: INDEX; Schema: tm_vault; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS tenants_external_tenant_id_type_key ON tm_vault.tenants USING btree (external_tenant_id, type) WHERE (external_tenant_id IS NOT NULL);


--
-- Name: access_groups access_groups_org_id_fkey; Type: FK CONSTRAINT; Schema: tm_vault; Owner: -
--

DO $do$ BEGIN
  ALTER TABLE ONLY tm_vault.access_groups
    ADD CONSTRAINT access_groups_org_id_fkey FOREIGN KEY (org_id) REFERENCES tm_vault.organizations(id);
EXCEPTION WHEN duplicate_object THEN NULL;
         WHEN duplicate_table  THEN NULL;
END $do$;
...
--
-- Name: access_groups access_groups_tenant_id_fkey; Type: FK CONSTRAINT; Schema: tm_vault; Owner: -
--

DO $do$ BEGIN
  ALTER TABLE ONLY tm_vault.access_groups
    ADD CONSTRAINT access_groups_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES tm_vault.tenants(id);
EXCEPTION WHEN duplicate_object THEN NULL;
         WHEN duplicate_table  THEN NULL;
END $do$;
...
DO $do$ BEGIN
  ALTER TABLE ONLY tm_vault.tenants
    ADD CONSTRAINT tenants_org_id_fkey FOREIGN KEY (org_id) REFERENCES tm_vault.organizations(id);
EXCEPTION WHEN duplicate_object THEN NULL;
         WHEN duplicate_table  THEN NULL;
END $do$;
